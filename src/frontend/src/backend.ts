...
export class Backend implements backendInterface {
    ...
    async getAsWarTeam(): Promise<Array<WarTeamPlayer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAsWarTeam();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getEuWarTeam(): Promise<Array<WarTeamPlayer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEuWarTeam();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWarLogs(): Promise<Array<WarLog>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWarLogs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
